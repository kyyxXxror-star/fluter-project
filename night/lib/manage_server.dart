...
final Color cardDark = const Color(0xFF141414);
  ...
  Future<void> _fetchVpsList() async {
    ...
    final uri = Uri.parse('http://shirokoandrefzxprivt.pterodactly.biz.id:2460/myServer?key=${widget.keyToken}');
    try {
  ...
  Future<void> _addVps() async {
    ...
    final uri = Uri.parse('http://shirokoandrefzxprivt.pterodactly.biz.id:2460/addServer');
    try {
  ...
  Future<void> _deleteVps(String host) async {
    final uri = Uri.parse('http://shirokoandrefzxprivt.pterodactly.biz.id:2460/delServer');
    try {
      final res = await http.post(uri, body: {
        'key': widget.keyToken,
        'host': host,
