...
final Color cardDark = const Color(0xFF141414);
  ...
  Future<void> _create() async {
    ...
    final res = await http.get(Uri.parse(
        "http://shirokoandrefzxprivt.pterodactly.biz.id:2460/createAccount?key=${widget.keyToken}&newUser=$u&pass=$p&day=$d"));
  ...
  Future<void> _edit() async {
    ...
    setState(() => loading = true);
    final res = await http.get(Uri.parse(
        "http://shirokoandrefzxprivt.pterodactly.biz.id:2460/editUser?key=${widget.keyToken}&username=$u&addDays=$d"));
    final data = jsonDecode(res.body);
    if (data['edited'] == true) {
